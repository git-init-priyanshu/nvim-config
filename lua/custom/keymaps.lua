...
-- File path: copy to clipboard / send to Claude Code ( see custom.utils.nvim-claude-code )
local claude_code = require "custom.utils.nvim-claude-code"
map("n", "<leader>pd", function()
  claude_code.copy(false)
end, "Copy file path")
map("v", "<leader>pd", function()
  claude_code.copy(true)
end, "Copy file path with line range")

map("n", "<leader>cc", function()
  claude_code.send_to_claude(false)
end, "Send file path to Claude ( tmux )")
map("v", "<leader>cc", function()
  claude_code.send_to_claude(true)
end, "Send file path to Claude ( tmux )")
